...
class CPU:
    ...
    def __init__(self):
        ...
        self.sp = 7       # stack pointer, decrement the SP (R7)
    ...
    ******* PUSH / POP *******
    ...
    def handle_POP(self,operand_a,operand_b):
        """
        POP Data
        - Copy the value from the memory at the address pointed to by SP into the register
        - Increase the SP
        """
